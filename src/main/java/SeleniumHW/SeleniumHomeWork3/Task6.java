...
public class Task6 {
     ...
     */
    @Test
    public void ShiromiAndEbi(){
        WebDriverManager.chromedriver().setup();
        WebDriver driver=new ChromeDriver();
        driver.navigate().to("https://demos.telerik.com/kendo-ui/websushi#");
        driver.manage().window().maximize();

        WebElement addToCart=driver.findElement(By.xpath("//li[8]/button"));
        addToCart.click();
        WebElement addToCart1=driver.findElement(By.xpath("//li[14]/button"));
        addToCart1.click();
        ...
        WebElement addToCartOneMOre=driver.findElement(By.xpath("//li[14]/button"));
