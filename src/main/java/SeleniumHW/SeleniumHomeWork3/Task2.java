...
public class Task2 {
    /*  avigate to "https://demos.telerik.com/kendoui/websushi#"
...
Validate item number is 0
    ...
    */
    ...
    public  void validateItem() throws InterruptedException {
        ...
        Thread.sleep(2000);
        WebElement edamameAddToCart = driver.findElement(By.xpath("//li[4]//button"));
        ...
        WebElement cart1= driver.findElement(By.xpath("//a[.='empty cart']"));
