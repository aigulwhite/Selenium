...
//        System.out.println(header.getText());
        ...
        Alert alert= driver.switchTo().alert();                        // this is how we handle alerts

        String actualText=alert.getText();            //getting the text from the alert box
        String expectedText="I am a JS Alert";        //we can either type of copy
        Assert.assertEquals(actualText,expectedText);
        alert.accept();

        WebElement message= driver.findElement(By.xpath("//p[@id='result']"));  //validating message after we accept the alert
