...
public class TestNGPracticeWithRealWebSite2 {
   ...
   public void validationOfAscendingOrderOfOptions() throws InterruptedException {
        ...
        Set<String> actualOptionsOrder=new LinkedHashSet<>(); // we want insertion order.
        Set<String> expectedOptionsOrder=new TreeSet<>();  // here I want them in ascending order
